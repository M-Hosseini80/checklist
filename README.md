...
این پروژه (پروژه چک لیست یا ToDo ، فقط یک پروژه شخصی و بتا و برای استفاده شخصی می باشد و شما می توانید آن را گسترش یا بهبود دهید.

این برنامه تمام اطلاعات وارد شده را در لوکال استوریج یا فضای محلی دستگاه شما ذخیره می کند.
